...
public class navermapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMark1.setOnClickListener(new Button.OnClickListener()
        {
            ...
            {
                setMarker(marker1, 33.2712, 126.5354, R.drawable.location_show, 0);
        ...
        btnMark2.setOnClickListener(new Button.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                setMarker(marker2, 33.49957, 126.531076, R.drawable.location_info, 10);
            }
        });
        ...
        btnMark3.setOnClickListener(new Button.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                setMarker(marker3, 33.49957, 126.531128, R.drawable.location_show, 0);
            }
        });
